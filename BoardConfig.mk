...
BOARD_KERNEL_CMDLINE := bootopt=64S3,32N2,64N2 buildvariant=user androidboot.boot_patchlevel=20210805
...
BOARD_AVB_BOOT_ADD_HASH_FOOTER_ARGS += --prop com.android.build.boot.security_patch:$(BOOT_SECURITY_PATCH)
BOARD_AVB_VENDOR_BOOT_ADD_HASH_FOOTER_ARGS += --prop com.android.build.vendor.security_patch:$(VENDOR_SECURITY_PATCH)
